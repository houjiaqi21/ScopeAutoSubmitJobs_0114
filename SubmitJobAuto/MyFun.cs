...
namespace SubmitJobAuto
{
    public partial class MyFun
    {
        ...
        public static void LaunchVs(String verson)
        {
            if(verson == "2019")
            {
                string vslocation = Json.Readjson("vs2019_location");
                ApplicationUnderTest.Launch(vslocation);
            }

            if (verson == "2022")
            {
                string vslocation = Json.Readjson("vs2022_location");
                ApplicationUnderTest.Launch(vslocation);
            }
        }
        ...
        /*--------------------获取WpfButton，若存在则点击--------------------*/
        public static WpfButton _MyWpfButton(UITestControl ParentWindow, string PropertyName)
        {
        ...
        public void Openscopeproject(string path)
        {
